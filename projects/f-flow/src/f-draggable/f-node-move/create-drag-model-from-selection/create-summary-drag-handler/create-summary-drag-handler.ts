  ...
  implements IExecution<CreateSummaryDragHandlerRequest, MoveSummaryDragHandler>
{
  ...
  public handle({
    dragRoots,
    participant,
  }: CreateSummaryDragHandlerRequest): MoveSummaryDragHandler {
    this._setLimitsToTheRootHandlers(dragRoots);

    return new MoveSummaryDragHandler(this._injector, participant, dragRoots);
  }
