...
import { findClosestMagneticGuides } from './find-closest-magnetic-guides';
...
describe('findClosestAlignment', () => {
  ...
  it('findNearestCoordinateByX should return undefined', () => {
    const result = findClosestMagneticGuides(elements, target, 10);
  ...
  it('should return undefined if no element is within the align threshold by X axis', () => {
    const result = findClosestMagneticGuides(elements, target, 5); // Smaller threshold
