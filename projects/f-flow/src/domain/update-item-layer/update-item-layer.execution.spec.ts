...
import { UpdateItemLayerExecution } from './update-item-layer.execution';
...
describe('UpdateItemLayerExecution', () => {
  ...
  beforeEach(() => {
    setupTestModule([ UpdateItemLayerExecution ]);
  ...
  it('should move TargetElement to last position in array', () => {
    ...
    fMediator.send(new UpdateItemLayerRequest(getSelectableItem(targetElement), itemContainer));
