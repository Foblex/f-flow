...
| ------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------ |
| Angular 17.3+       | `19.x`                       | Current line for modern Angular apps. Angular 17.3 through Angular 20+ use the same install path here. |
...
```bash
npm install @foblex/flow@19 @foblex/platform@1.0.4 @foblex/mediator@1.1.3 @foblex/2d@1.2.2 @foblex/utils@1.1.1
```
...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `19.x`           | `@foblex/platform@1.0.4`, `@foblex/mediator@1.1.3`, `@foblex/2d@1.2.2`, `@foblex/utils@1.1.1`                               |
