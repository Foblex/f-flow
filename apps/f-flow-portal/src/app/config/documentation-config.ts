...
export const DOCUMENTATION_CONFIGURATION: IDocumentationConfiguration = {
  ...
  return defineNavigationGroup('Introduction', [
    {
      ...
      pageTitle: 'Foblex Flow Docs — Getting Started with Angular Node Editors',
      description:
...
function seoPagesGroup(): INavigationGroup {
  return defineNavigationGroup('Use Cases', [
    ...
    },
    {
      ...
      pageTitle: 'React Flow vs Foblex Flow — Honest Comparison for Angular Teams',
      description:
