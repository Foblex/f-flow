...
export const EXAMPLES_CONFIGURATION: IDocumentationConfiguration = {
...
function pluginsGroup() {
  return defineNavigationGroup('Plugins', [
    ...
    },
    {
      ...
      image_dark: './previews/examples/dagre-layout-auto.dark.png',
      description:
    ...
    },
    {
      ...
      image_dark: './previews/examples/elk-layout-auto.dark.png',
      description:
