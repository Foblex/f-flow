...
toc: false
wideContent: true
summary: "Automatic graph relayout with ELK.js and Foblex Flow auto mode."
primaryKeyword: "angular elk auto layout example"
...
- `@foblex/flow-elk-layout` calculates node positions with ELK.js
- `@foblex/flow` detects graph changes, runs auto relayout, and redraws the scene
- your app remains the owner of graph state through `writeback`
...
4. Flow then runs ELK.js automatically and sends the new positions back through `writeback`.
...
[component.html] <<< https://raw.githubusercontent.com/Foblex/f-flow/main/projects/f-examples/plugins/elk-layout-auto/elk-layout-auto.html
[component.ts] <<< https://raw.githubusercontent.com/Foblex/f-flow/main/projects/f-examples/plugins/elk-layout-auto/elk-layout-auto.ts
[component.scss] <<< https://raw.githubusercontent.com/Foblex/f-flow/main/projects/f-examples/plugins/elk-layout-auto/elk-layout-auto.scss
